<picture>
  ...
  <img src="img/f-split-code-light.svg" alt="Hey, my name is Kevin-Christian Joseph Giraldo-Barbosa, goes by KC">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="img/head-about-dark.svg">
  <img src="img/head-about-light.svg" alt="About me">
</picture>

- 💻 JavaScript developer based in Toronto, ON who really enjoys building software focused on the user-experience
...
<picture>
  ...
  <img src="img/head-stack-light.svg" alt="Building with">
</picture>
...
<picture>
  ...
  <img src="img/head-pets-light.svg" alt="Co-maintainers">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="img/co-maintainers-dark.svg">
  <img src="img/co-maintainers-light.svg" alt="Kingsley, a golden retriever, and Tyson, a tabby cat">
</picture>
Grateful that all repo maintenance is handled by these talented orchestrators.
